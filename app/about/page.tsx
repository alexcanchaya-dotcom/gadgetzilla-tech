...
export default function AboutPage() {
  return (
    ...
    >
      ...
      <p>
        The <Link href="/cost-per-use">cost-per-use</Link> page turns a price and how often you use a gadget into one named number. Amazon catalog picks sit under that free result, not before it.
      </p>
